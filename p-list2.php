...
switch($class) {
   ...
   default:       // 카테고리별 메뉴 화면에 출력할 상품 목록
       $result = mysql_query("select * from product where order by hit desc", $con);
		break;
}
...
echo("<table align=center border=0><tr align=center><td colspan=4><font class='p' size=7 color=grey>BEST</td></tr></table><br><br>");
